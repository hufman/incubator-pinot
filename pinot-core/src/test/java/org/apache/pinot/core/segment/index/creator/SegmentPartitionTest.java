...
public class SegmentPartitionTest {
  ...
  private List<Integer> _expectedPartitions;
  ...
  public void testMetadata() {
    ...
    List<Integer> actualPartitions = columnMetadata.getPartitions();
  ...
  private void buildSegment()
    ...
    _expectedPartitions = new ArrayList<>(partitionSet);
    _expectedPartitions.sort(null);
  }
}
