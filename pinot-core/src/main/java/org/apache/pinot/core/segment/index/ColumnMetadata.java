...
public class ColumnMetadata {
  ...
  public static ColumnMetadata fromPropertiesConfiguration(String column, PropertiesConfiguration config) {
    ...
    if (partitionFunctionName != null) {
      ...
      builder.setPartitionValues(ColumnPartitionMetadata
  ...
  public static class Builder {
    ...
    private List<Integer> partitionValues = null;
    ...
    public Builder setPartitionValues(List<Integer> partitionValues) {
  ...
  private ColumnMetadata(String columnName, int cardinality, int totalDocs, int totalRawDocs, int totalAggDocs,
      ...
      PartitionFunction partitionFunction, int numPartitions, List<Integer> partitions, String dateTimeFormat,
