...
public class SegmentPartitionMetadata {
  ...
  /**
   * Returns the list of partitions for the specified column.
   * Returns null if the column is not partitioned.
   *
   * @param column Column for which to return the list of partitions.
   * @return List of partitions for the specified column.
   */
  public List<Integer> getPartitions(String column) {
    ColumnPartitionMetadata columnPartitionMetadata = _columnPartitionMap.get(column);
